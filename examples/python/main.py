"""
Example: How to call the redfin-scraper actor using Apify API Client

For full documentation of the Apify Client for Python, see: https://docs.apify.com/api/client/python
For full documentation of the actor, see: https://apify.com/lexis-solutions/redfin-scraper
...
def run_actor():
    """Run the redfin-scraper actor and retrieve results."""
    ...
    actor_id = "lexis-solutions/redfin-scraper"
    print(f"Starting actor: {actor_id}")

    run = client.actor(actor_id).call(
        run_input={
            "startUrls": [{"url":"https://www.redfin.com/city/11203/CA/Los-Angeles/filter/property-type=house,min-price=80M,max-price=150M,min-beds=5,min-baths=4,school-types=elementary+middle+high"}],
            "mode": "buy",
            "maxPages": 1,
